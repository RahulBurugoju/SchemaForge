    ...
    edges: [
      {
        ...
        source: "col_users",
        target: "col_posts",
        sourceHandle: "col_users-col_sn_u_1",
        targetHandle: "col_posts-col_sn_p_2",
        type: "smoothstep",
      },
      {
        ...
        source: "col_posts",
        target: "col_comments",
        sourceHandle: "col_posts-col_sn_p_1",
        targetHandle: "col_comments-col_sn_c_2",
        type: "smoothstep",
      },
      {
        ...
        target: "col_comments",
        sourceHandle: "col_users-col_sn_u_1",
        targetHandle: "col_comments-col_sn_c_3",
        type: "smoothstep",
      },
      {
        ...
        sourceHandle: "col_users-col_sn_u_1",
        targetHandle: "col_followers-col_sn_f_2",
        type: "smoothstep",
      },
    ],
