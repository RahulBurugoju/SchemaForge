    ...
    edges: [
      {
        ...
        source: "tbl_authors",
        target: "tbl_posts",
        sourceHandle: "source-tbl_authors-col_a_1",
        targetHandle: "target-tbl_posts-col_po_2",
        type: "smoothstep",
      },
      {
        ...
        source: "tbl_posts",
        target: "tbl_comments",
        sourceHandle: "source-tbl_posts-col_po_1",
        targetHandle: "target-tbl_comments-col_cm_2",
        type: "smoothstep",
      },
      {
        id: "edge_posts_tags",
        ...
        sourceHandle: "source-tbl_posts-col_po_1",
        targetHandle: "target-tbl_post_tags-col_pt_2",
        type: "smoothstep",
      },
      {
        ...
        source: "tbl_tags",
        target: "tbl_post_tags",
        sourceHandle: "source-tbl_tags-col_tg_1",
        targetHandle: "target-tbl_post_tags-col_pt_3",
        type: "smoothstep",
      },
    ],
