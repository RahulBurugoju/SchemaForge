    ...
    edges: [
      {
        ...
        targetHandle: "target-tbl_orders-col_o_2",
        type: "smoothstep",
      },
      {
        ...
        target: "tbl_products",
        sourceHandle: "source-tbl_categories-col_c_1",
        targetHandle: "target-tbl_products-col_p_2",
        type: "smoothstep",
      },
      {
        ...
        sourceHandle: "source-tbl_orders-col_o_1",
        targetHandle: "target-tbl_order_items-col_oi_2",
        type: "smoothstep",
      },
      {
        ...
        source: "tbl_products",
        target: "tbl_order_items",
        sourceHandle: "source-tbl_products-col_p_1",
        targetHandle: "target-tbl_order_items-col_oi_3",
        type: "smoothstep",
      },
    ],
