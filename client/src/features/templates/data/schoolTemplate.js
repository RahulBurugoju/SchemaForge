    ...
    edges: [
      {
        ...
        source: "tbl_teachers",
        target: "tbl_courses",
        sourceHandle: "tbl_teachers-col_tch_1",
        targetHandle: "tbl_courses-col_crs_2",
        type: "smoothstep",
      },
      {
        ...
        sourceHandle: "tbl_students-col_stu_1",
        targetHandle: "tbl_enrollments-col_enr_2",
        type: "smoothstep",
      },
      {
        ...
        source: "tbl_courses",
        target: "tbl_enrollments",
        sourceHandle: "tbl_courses-col_crs_1",
        targetHandle: "tbl_enrollments-col_enr_3",
        type: "smoothstep",
      },
    ],
